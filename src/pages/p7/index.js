        ...
        <main className="bg-light mb-5">
            <div className="p-4 d-flex flex-column flex-md-row flex-sm-row">
                <div className="col-lg-6 col-md-6">
                    <h2>Piso Carvalho Escurecido</h2>
                    <img src="/assets/images/piso7.jpeg" alt="IMG Piso Carvalho Escurecido" height="300" />
                ...
                <div className="col-lg-6 col-md-6" >
                    <h3>Descrição</h3>
                    <p>Piso de carvalho Escurecido, madeira sustentável e qualidade impecável.</p>
                </div>
            </div>
        </main>
    );
